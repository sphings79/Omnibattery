...
const I18N = {
  en: {
    ...
    secPrimary: "Primary battery", itemPrimaryBattery: "Primary battery", itemPrimaryFeedforward: "Feed the house load forward",
  ...
  es: {
    ...
    secPrimary: "Batería principal", itemPrimaryBattery: "Batería principal", itemPrimaryFeedforward: "Anticipar el consumo de la casa",
  ...
  ca: {
    ...
    secPrimary: "Bateria principal", itemPrimaryBattery: "Bateria principal", itemPrimaryFeedforward: "Anticipar el consum de la casa",
  ...
  de: {
    ...
    secPrimary: "Primärbatterie", itemPrimaryBattery: "Primärbatterie", itemPrimaryFeedforward: "Hauslast vorsteuern",
  ...
  fr: {
    ...
    secPrimary: "Batterie principale", itemPrimaryBattery: "Batterie principale", itemPrimaryFeedforward: "Anticiper la consommation du foyer",
  ...
  nl: {
    ...
    secPrimary: "Primaire batterij", itemPrimaryBattery: "Primaire batterij", itemPrimaryFeedforward: "Huisverbruik vooruitsturen",
...
const SYS_HELP = {
  en: {
    ...
    primary_feedforward: "Commands the primary battery to the load the batteries actually have to cover — house consumption less whatever PV is supplying — instead of waiting for the grid to deviate. Useful when a second regulator shares the meter — a hybrid inverter on self-consumption removes the deviation before this controller sees one, so the other battery never runs. With this on the primary gets there first, and the other regulator stays available as a fallback. Check the switch attributes against your meter before enabling: they show the detected house load either way.",
